...
public class LetReturnIt {
    ...
    static Expression buildExpression(@NotNull PsiElement element, @NotNull Document document, boolean synthetic) <fold text='{...}' expand='true'>{
        ...
        if <fold text='' expand='false'>(</fold>element instanceof PsiForStatement<fold text='' expand='false'>)</fold> <fold text='{...}' expand='true'>{
            <fold text='val' expand='false'><fold text='' expand='true'>Expression</fold> expression = </fold>ForStatementExpressionExt.getForStatementExpression(<fold text='' expand='false'>(PsiForStatement) </fold>element, document)<fold text=' ?: return null' expand='true'>;
        ...
        if <fold text='' expand='false'>(</fold>element instanceof PsiForeachStatement<fold text='' expand='false'>)</fold> <fold text='{...}' expand='true'>{
            <fold text='val' expand='false'><fold text='' expand='true'>Expression</fold> expression = </fold>getForeachStatementExpression(<fold text='' expand='false'>(PsiForeachStatement) </fold>element)<fold text=' ?: return null' expand='true'>;
            if (expression == null) <fold text='{...}' expand='true'>{
                return null;
            }</fold></fold>
        }</fold>
        if <fold text='' expand='false'>(</fold>element instanceof PsiIfStatement<fold text='' expand='false'>)</fold> <fold text='{...}' expand='true'>{
            <fold text='val' expand='false'><fold text='' expand='true'>Expression</fold> expression = </fold>getIfExpression(<fold text='' expand='false'>(PsiIfStatement) </fold>element, document)<fold text=' ?: return null' expand='true'>;
            if (expression == null) <fold text='{...}' expand='true'>{
                return null;
            }</fold></fold>
        }</fold>
        if <fold text='' expand='false'>(</fold>element instanceof PsiWhileStatement<fold text='' expand='false'>)</fold> <fold text='{...}' expand='true'>{
            <fold text='val' expand='false'><fold text='' expand='true'>Expression</fold> expression = </fold>getWhileStatement(<fold text='' expand='false'>(PsiWhileStatement) </fold>element)<fold text=' ?: return null' expand='true'>;
            if (expression == null) <fold text='{...}' expand='true'>{
                return null;
            }</fold></fold>
        }</fold>
        ...
        if <fold text='' expand='false'>(</fold>element instanceof PsiCatchSection<fold text='' expand='false'>)</fold> <fold text='{...}' expand='true'>{
            <fold text='val' expand='false'><fold text='' expand='true'>Expression</fold> expression = </fold>getCatchStatement(<fold text='' expand='false'>(PsiCatchSection) </fold>element)<fold text=' ?: return null' expand='true'>;
            if (expression == null) <fold text='{...}' expand='true'>{
                return null;
            }</fold></fold>
        }</fold>
        if <fold text='' expand='false'>(</fold>element instanceof PsiDoWhileStatement<fold text='' expand='false'>)</fold> <fold text='{...}' expand='true'>{
            <fold text='val' expand='false'><fold text='' expand='true'>Expression</fold> expression = </fold>getDoWhileStatement(<fold text='' expand='false'>(PsiDoWhileStatement) </fold>element)<fold text=' ?: return null' expand='true'>;
            if (expression == null) <fold text='{...}' expand='true'>{
                return null;
            }</fold></fold>
        }</fold>
        if <fold text='' expand='false'>(</fold>element instanceof PsiSwitchStatement<fold text='' expand='false'>)</fold> <fold text='{...}' expand='true'>{
            <fold text='val' expand='false'><fold text='' expand='true'>Expression</fold> expression = </fold>getSwitchStatement(<fold text='' expand='false'>(PsiSwitchStatement) </fold>element)<fold text=' ?: return null' expand='true'>;
            if (expression == null) <fold text='{...}' expand='true'>{
                return null;
            }</fold></fold>
        }</fold>
        if <fold text='' expand='false'>(</fold>element instanceof PsiArrayAccessExpression && settings.<fold text='state' expand='false'>getState()</fold>.<fold text='getExpressionsCollapse' expand='false'>getGetExpressionsCollapse()</fold><fold text='' expand='false'>)</fold> <fold text='{...}' expand='true'>{
            <fold text='val' expand='false'><fold text='' expand='true'>Expression</fold> expression = </fold>getArrayAccessExpression(<fold text='' expand='false'>(PsiArrayAccessExpression) </fold>element, document)<fold text=' ?: return null' expand='true'>;
            if (expression == null) <fold text='{...}' expand='true'>{
                return null;
            }</fold></fold>
        }</fold>
        if <fold text='' expand='false'>(</fold>element instanceof PsiMethodCallExpression<fold text='' expand='false'>)</fold> <fold text='{...}' expand='true'>{
            <fold text='val' expand='false'><fold text='' expand='true'>Expression</fold> expression = </fold>MethodCallExpressionExt.getMethodCallExpression(<fold text='' expand='false'>(PsiMethodCallExpression) </fold>element, document)<fold text=' ?: return null' expand='true'>;
            if (expression == null) <fold text='{...}' expand='true'>{
                return null;
            }</fold></fold>
        }</fold>
        if <fold text='' expand='false'>(</fold>element instanceof PsiReferenceExpression<fold text='' expand='false'>)</fold> <fold text='{...}' expand='true'>{
            <fold text='val' expand='false'><fold text='' expand='true'>Expression</fold> expression = </fold>Helper.getReferenceExpression(<fold text='' expand='false'>(PsiReferenceExpression) </fold>element)<fold text=' ?: return null' expand='true'>;
            if (expression == null) <fold text='{...}' expand='true'>{
                return null;
            }</fold></fold>
        }</fold>
        if <fold text='' expand='false'>(</fold>element instanceof PsiNewExpression<fold text='' expand='false'>)</fold> <fold text='{...}' expand='true'>{
            <fold text='val' expand='false'><fold text='' expand='true'>Expression</fold> expression = </fold>NewExpressionExt.getNewExpression(<fold text='' expand='false'>(PsiNewExpression) </fold>element, document)<fold text=' ?: return null' expand='true'>;
            if (expression == null) <fold text='{...}' expand='true'>{
                return null;
            }</fold></fold>
        }</fold>
        if <fold text='' expand='false'>(</fold>element instanceof PsiLiteralExpression<fold text='' expand='false'>)</fold> <fold text='{...}' expand='true'>{
            <fold text='val' expand='false'><fold text='' expand='true'>Expression</fold> expression = </fold>Helper.getLiteralExpression(<fold text='' expand='false'>(PsiLiteralExpression) </fold>element)<fold text=' ?: return null' expand='true'>;
            if (expression == null) <fold text='{...}' expand='true'>{
                return null;
            }</fold></fold>
        }</fold>
        if <fold text='' expand='false'>(</fold>element instanceof PsiAssignmentExpression<fold text='' expand='false'>)</fold> <fold text='{...}' expand='true'>{
            <fold text='val' expand='false'><fold text='' expand='true'>Expression</fold> expression = </fold>AssignmentExpressionExt.getAssignmentExpression(<fold text='' expand='false'>(PsiAssignmentExpression) </fold>element, document)<fold text=' ?: return null' expand='true'>;
            if (expression == null) <fold text='{...}' expand='true'>{
                return null;
            }</fold></fold>
        }</fold>
        if <fold text='' expand='false'>(</fold>element instanceof PsiPolyadicExpression<fold text='' expand='false'>)</fold> <fold text='{...}' expand='true'>{
            <fold text='val' expand='false'><fold text='' expand='true'>Expression</fold> expression = </fold>getPolyadicExpression(<fold text='' expand='false'>(PsiPolyadicExpression) </fold>element, document)<fold text=' ?: return null' expand='true'>;
            if (expression == null) <fold text='{...}' expand='true'>{
                return null;
            }</fold></fold>
        }</fold>
        if <fold text='' expand='false'>(</fold>element instanceof PsiBinaryExpression<fold text='' expand='false'>)</fold> <fold text='{...}' expand='true'>{
            <fold text='val' expand='false'><fold text='' expand='true'>Expression</fold> expression = </fold>BinaryExpressionExt.getBinaryExpression(<fold text='' expand='false'>(PsiBinaryExpression) </fold>element, document)<fold text=' ?: return null' expand='true'>;
            if (expression == null) <fold text='{...}' expand='true'>{
                return null;
            }</fold></fold>
        }</fold>
        if <fold text='' expand='false'>(</fold>element instanceof PsiConditionalExpression<fold text='' expand='false'>)</fold> <fold text='{...}' expand='true'>{
            <fold text='val' expand='false'><fold text='' expand='true'>Expression</fold> expression = </fold>getConditionalExpression(<fold text='' expand='false'>(PsiConditionalExpression) </fold>element, document)<fold text=' ?: return null' expand='true'>;
            if (expression == null) <fold text='{...}' expand='true'>{
                return null;
            }</fold></fold>
        }</fold>
        if <fold text='' expand='false'>(</fold>element instanceof PsiPrefixExpression<fold text='' expand='false'>)</fold> <fold text='{...}' expand='true'>{
            <fold text='val' expand='false'><fold text='' expand='true'>Expression</fold> expression = </fold>PrefixExpressionExt.getPrefixExpression(<fold text='' expand='false'>(PsiPrefixExpression) </fold>element, document)<fold text=' ?: return null' expand='true'>;
            if (expression == null) <fold text='{...}' expand='true'>{
                return null;
            }</fold></fold>
        }</fold>
        if <fold text='' expand='false'>(</fold>element instanceof PsiParenthesizedExpression
            ...
            if (e != null) <fold text='{...}' expand='true'>{
                <fold text='val' expand='false'><fold text='' expand='true'>@Nullable Expression</fold> expression = </fold>getExpression(e, document, synthetic)<fold text=' ?: return null' expand='true'>;
                if (expression == null) <fold text='{...}' expand='true'>{
                    return null;
                }</fold></fold>
            }</fold>
        ...
        if <fold text='' expand='false'>(</fold>element instanceof PsiTypeCastExpression
                && settings.<fold text='state' expand='false'>getState()</fold>.<fold text='castExpressionsCollapse' expand='false'>getCastExpressionsCollapse()</fold><fold text='' expand='false'>)</fold> <fold text='{...}' expand='true'>{
            <fold text='val' expand='false'><fold text='' expand='true'>TypeCast</fold> expression = </fold>getTypeCastExpression(<fold text='' expand='false'>(PsiTypeCastExpression) </fold>element, document)<fold text=' ?: return null' expand='true'>;
            if (expression == null) <fold text='{...}' expand='true'>{
                return null;
            }</fold></fold>
        }</fold>
        if <fold text='' expand='false'>(</fold>settings.<fold text='state' expand='false'>getState()</fold>.<fold text='varExpressionsCollapse' expand='false'>getVarExpressionsCollapse()</fold>
            ...
            <fold text='val' expand='false'><fold text='' expand='true'>Expression</fold> expression = </fold>getVariableDeclaration(<fold text='' expand='false'>(PsiVariable) </fold>element)<fold text=' ?: return null' expand='true'>;
            if (expression == null) <fold text='{...}' expand='true'>{
                return null;
            }</fold></fold>
        }</fold>
        if <fold text='' expand='false'>(</fold>element instanceof PsiCodeBlock<fold text='' expand='false'>)</fold> <fold text='{...}' expand='true'>{
            <fold text='val' expand='false'><fold text='' expand='true'>Expression</fold> expression = </fold>getCodeBlockExpression(<fold text='' expand='false'>(PsiCodeBlock) </fold>element)<fold text=' ?: return null' expand='true'>;
            if (expression == null) <fold text='{...}' expand='true'>{
                return null;
            }</fold></fold>
        }</fold>
        if <fold text='' expand='false'>(</fold>element instanceof PsiClass psiClass<fold text='' expand='false'>)</fold> <fold text='{...}' expand='true'>{
            <fold text='val' expand='false'><fold text='' expand='true'>Expression</fold> expression = </fold>PsiClassExt.createExpression(psiClass)<fold text=' ?: return null' expand='true'>;
            if (expression == null) <fold text='{...}' expand='true'>{
                return null;
            }</fold></fold>
        }</fold>
