...
public class LogBrackets {
    ...
    public Data log(Data data) <fold text='{...}' expand='true'>{
        ...
        log.error("Missing 1 parameter - Name: <fold text='$' expand='false'>{}, Age: {}, City: {}, Salary: {}", </fold>name<fold text=', Age: $' expand='false'>, </fold>age<fold text=', City: $' expand='false'>, </fold>city<fold text=', Salary: {}")' expand='false'>)</fold>;
        log.error("Missing 2 parameters - Name: <fold text='$' expand='false'>{}, Age: {}, City: {}, Salary: {}", </fold>name<fold text=', Age: $' expand='false'>, </fold>age<fold text=', City: {}, Salary: {}")' expand='false'>)</fold>;
        log.error("Missing 3 parameters - Name: <fold text='$' expand='false'>{}, Age: {}, City: {}, Salary: {}", </fold>name<fold text=', Age: {}, City: {}, Salary: {}")' expand='false'>)</fold>;
        log.error("Missing all parameters - Name: {}, Age: {}, City: {}, Salary: {}");

        try <fold text='{...}' expand='true'>{
            log.warn("Warning message with 3 parameters and formatting - Name: <fold text='$' expand='false'>{}, Age: {}, City: {}",
            ...
            log.error("error2 <fold text='$' expand='false'>{}", </fold>log(data)<fold text='"$' expand='false'>, </fold>e, e);
        }</fold>
