...
public class ConcatenationTestData {
    public static void main(String[] args) <fold text='{...}' expand='true'>{
        ...
        List<String> streamToList = <fold text='' expand='false'>Arrays.stream(</fold>args<fold text='' expand='false'>)</fold>.map(<fold text='toUpperCase' expand='false'>String::toUpperCase</fold>)<fold text='.' expand='false'>.collect(Collectors.</fold>toList()<fold text='' expand='false'>)</fold>;
        System.out.println(streamToList);
        streamToList = <fold text='' expand='false'>Arrays.stream(</fold>args<fold text='' expand='false'>)</fold>.map(<fold text='toUpperCase' expand='false'>String::toUpperCase</fold>)<fold text='.' expand='false'>.collect(Collectors.</fold>toList()<fold text='' expand='false'>)</fold>;
        System.out.println(streamToList);
        streamToList = <fold text='' expand='false'>Arrays.stream(</fold>args<fold text='' expand='false'>)</fold>.map(<fold text='toUpperCase' expand='false'>String::toUpperCase</fold>)<fold text='.' expand='false'>.collect(Collectors.</fold>toList()<fold text='' expand='false'>)</fold>;
        System.out.println(streamToList);
        streamToList = <fold text='' expand='false'>Arrays.stream(</fold>args<fold text='' expand='false'>)</fold>.map(<fold text='toUpperCase' expand='false'>String::toUpperCase</fold>)<fold text='.' expand='false'>.collect(Collectors.</fold>toList()<fold text='' expand='false'>)</fold>;
        ...
        streamToList = list<fold text='.' expand='false'>.stream().</fold>map(<fold text='toUpperCase' expand='false'>String::toUpperCase</fold>)<fold text='.' expand='false'>.collect(Collectors.</fold>toList()<fold text='' expand='false'>)</fold>;
        System.out.println(streamToList);
        streamToList = list<fold text='.' expand='false'>.stream().</fold>map(<fold text='toUpperCase' expand='false'>String::toUpperCase</fold>)<fold text='.' expand='false'>.collect(Collectors.</fold>toList()<fold text='' expand='false'>)</fold>;
        System.out.println(streamToList);
        streamToList = list<fold text='.' expand='false'>.stream().</fold>map(<fold text='toUpperCase' expand='false'>String::toUpperCase</fold>)<fold text='.' expand='false'>.collect(Collectors.</fold>toList()<fold text='' expand='false'>)</fold>;
